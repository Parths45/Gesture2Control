...
ONE_EURO_BETA = 15.0        # Increased from 4.0 for faster response during movement
...
PINCH_THRESHOLD_NORM = 0.08        # Increased from 0.06/0.07 for easier triggering
...
DELTA_SMOOTHING = 0.3    # Reduced from 0.6 to reduce lag/inertia

# --- GESTURES ---
# Pinch
PINCH_THRESHOLD_NORM = 0.08
CLICK_COOLDOWN = 0.4
