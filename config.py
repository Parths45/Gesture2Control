...
SMOOTHING_FACTOR = 10  # Baseline (increased for steadier/slower cursor)
SMOOTHING_LPF = 0.2   # Low Pass Filter Alpha (0.0 - 1.0, lower = smoother)
# Dynamic Ranges
MIN_SMOOTHING = 3.0   # Fast movement (Responsive)
MAX_SMOOTHING = 25.0  # Slow movement (Very Smooth)
SMOOTHING_SPEED_THRESHOLD = 300 # Pixel distance to trigger max responsiveness (larger -> only big moves become responsive)
...
FAILSAFE_FPS = 15 # Minimum FPS before pausing for safety (raised to avoid slow/laggy control)
